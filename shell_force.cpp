...
int main() {
	...
	Vector3d Ei, Ef;
	constE = 1.7242e7;
        cout << "Enter poisson ratio:" << endl;
	cin >> nu;
	t=0.8;
	Vector2d newV;
	Vector3d Min, Max;
	MatrixXd Vbar, dI(18,2), V, dV, V2;
	MatrixXi F;
	...
	EN=Enormal(FN,EdgeF);		
	FFtot=Force(constE, nu, t, F, Vbar, V, ENbar, EN, EdgeNV);   //Change the output for Force to FF << FF1, FF2;
/*
...
//----------------------Output Force-----------------------------------------------------------	
	int Ratio;
        cout << "enter shrinking ratio for force" << endl;
        cin >> Ratio;
	Vnew= V+FFtot/Ratio;
//	cout << FFtot << endl;
//----------------------------------------------------------------------------------------------	
